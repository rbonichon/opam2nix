...
type universe = {
  ...
  repos : Repo.t list;
  mutable packages :
    (Repo.loaded_package, error) result OpamTypes.package_map;
...
(** [build_universe] *)
val build_universe: external_constraints:external_constraints ->
base_packages:OpamPackage.Name.t list ->
constrained_versions:(OpamPackage.Name.t * OpamTypes.version) list ->
direct_definitions:Repo.direct_package list -> unit -> universe ;;
