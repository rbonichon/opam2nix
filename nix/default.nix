...
let
  ...
  callOcamlPackage = ocamlPackages.newScope {
    ...
    ocamlmerlin = callOcamlPackage <nixpkgs/pkgs/development/tools/ocaml/merlin/default.nix> { };
    ocamlformat = callOcamlPackage <nixpkgs/pkgs/development/tools/ocaml/ocamlformat/default.nix> { };
  };

in
callOcamlPackage ./opam2nix.nix { inherit self; }
